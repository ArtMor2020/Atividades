...
namespace Campeonato.Controllers
{
    public class ModalidadesController : Controller
    {
        ...
        public ModalidadesController(CampeonatoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Individual")] Modalidade modalidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Individual")] Modalidade modalidade)
        {
            if (id != modalidade.Id)
            {
                return NotFound();
